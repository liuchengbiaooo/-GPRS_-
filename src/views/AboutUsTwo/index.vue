<template>
  <div class="wrap">
    ...
    <!-- <div class="content-bottom-wrap">
      <div class="content-bottom-text1" >忘记密码</div>
      <div class="content-bottom-text2" >注册新用户</div>
    </div>-->
...
export default {
  ...
  methods: {
    register() {
      ...
      //let phoneNumber = "13751015183";
      //let passWord = "888888";
      if (phoneNumber == "" || passWord == "") {
        Toast.fail("请输入正确的账号密码!");
        return;
      }
